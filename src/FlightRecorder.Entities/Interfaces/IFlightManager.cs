...
namespace FlightRecorder.Entities.Interfaces
{
    ...
    {
        Task<Flight> AddAsync(string callsign, string number, string embarkation, string destination, long airlineId);
        Task<Flight> AddIfNotExistsAsync(string callsign, string number, string embarkation, string destination, long airlineId);
        ...
        Task<Flight> UpdateAsync(long id, string callsign, string number, string embarkation, string destination, long airlineId);
